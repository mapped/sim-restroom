    ...
    >
      ...
      <div className="px-2 py-1.5 flex items-center justify-between border-b border-slate-300">
        ...
        <div className="flex items-center gap-1">
          <span
            className={`text-[8px] px-1.5 py-0.5 border font-bold tracking-wider ${PRIORITY_STYLES[wo.priority]}`}
          >
            {wo.priority}
          </span>
          <span
            className={`text-[8px] px-1.5 py-0.5 border font-bold tracking-wider ${STATUS_STYLES[wo.status]}`}
          >
            {statusLabel}
          </span>
        </div>
